...
def wall_builder(value, roof_block = ROOF_BLOCK, wall_block = '|'):
    roof = ' --- --- --- '
    wall_element = ' | '
    line = 0
    row = 0
...
# метод main - кге?
# нет интерфейса-приглашалки. типа "здравствуйте, в эту игру надо играть вот так, сейчас ходит крестик, а вот сейчас ходит нолик и тд"
# разделить статусы ячеек - либо это число, либо строка

# список задач c practice python
# сделать фккаунт на гитхабе
# игра "жизнь" - начать